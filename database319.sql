...
INSERT INTO `cs319projectapp_useraccount` VALUES (1,'pbkdf2_sha256$870000$VCX7hdXBKpGQsBtzNAhvsi$OAvCfeWyqLCq+teSbrCfLONBzj8nO/qwjDVVAA0LQr4=','2024-12-06 18:26:46.036713',1,'Hakanto','','','i.hakan_karakoc@hotmail.com',1,1,'2024-12-06 18:26:09.754322','Guest'),(2,'pbkdf2_sha256$870000$ORCvv09yIqYaLITYc33x8g$Mjs464SQfUeTD38x0i5AhDPzvnfsfhGIGDJZ7EEg9mE=',NULL,0,'guide','','','',0,1,'2024-12-06 18:28:19.491593','Guide'),(3,'pbkdf2_sha256$870000$zphA8dbzIL5CwD31ZkiCBi$mOwo6GFZQ8ELKY7tMjhb60TxoRMCz/aFUM/YxGwwndI=',NULL,0,'advisor','','','',0,1,'2024-12-06 18:28:19.861454','Advisor'),(4,'pbkdf2_sha256$870000$n0QQeQCcUrEVMr9fIyOhRf$LcekSu5mWfZCw9odfAhY/ePZFdfARXVUai78ZpMRDII=',NULL,0,'coordinator','','','',0,1,'2024-12-06 18:28:20.212893','Coordinator'),(5,'pbkdf2_sha256$870000$36Y0D6AVmwC3GmYRiPmuWJ$DRnQP7KFrrN5qjVWMOLvjttdrsPdfKhh12ZqRUG9Dog=',NULL,0,'director','','','',0,1,'2024-12-06 18:28:20.560639','Director'),(6,'pbkdf2_sha256$870000$CLNrVDo9vanB5iw9k4NkkZ$7x55Nw81Ornr0OIjvG9RdjwobJTWf13CuhHdMAr0BPs=',NULL,0,'promo','','','',0,1,'2024-12-06 18:28:20.908215','Promo_Coordinator'),(7,'pbkdf2_sha256$870000$9s9HgtX5BXPMxC4r9UN9bh$wdR1v/K5INaJKFh56vV4eR3SwLhWL3wc5NKX0U8qG0o=',NULL,0,'guest','','','',0,1,'2024-12-06 18:28:21.256441','Guest');
...
CREATE TABLE `cs319projectapp_useraccount_groups` (
  ...
  CONSTRAINT `cs319projectapp_user_useraccount_id_c7d67d1d_fk_cs319proj` FOREIGN KEY (`useraccount_id`) REFERENCES `cs319projectapp_useraccount` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cs319projectapp_useraccount_user_permissions` (
  ...
  CONSTRAINT `cs319projectapp_user_useraccount_id_566e24e5_fk_cs319proj` FOREIGN KEY (`useraccount_id`) REFERENCES `cs319projectapp_useraccount` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
